...
public class PartidasService {
    ...
    public Partidas salvarPartidas(PartidasDTO partidasDTO) {
        Times time1 = timeRepository.findById(partidasDTO.time1Id()).orElseThrow(() -> new RuntimeException("Time A não encontrado"));
        Times time2 = timeRepository.findById(partidasDTO.time2Id()).orElseThrow(() -> new RuntimeException("Time B não encontrado"));
    ...
    public List<Partidas> listarJogos() {return partidasRepository.findAll();
    }
}
